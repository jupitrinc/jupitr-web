    ...
    <div className="flex flex-col gap-5">
      <Card type="section">
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-5">
            ...
            <SkillCard skill={{ id: "3", name: "Cloud computing", level: 2 }} />
          </div>
        </div>
      </Card>
      ...
      <Card type="section">
        <div className="flex flex-col gap-10">
          ...
          <VideoPlayer src="https://res.cloudinary.com/dyfg2jhz8/video/upload/f_auto:video,q_auto/v1/production/company/d75f8ef2-40d4-4b4b-9047-c1b73c55b20d/jobs/d3ba1cf3-0a8d-4c09-9e8c-32eb967613f4/4b61daac-c490-4f3c-9f15-8e42cb527476-1695797858118/qukcglt0ukmuaadrjg59" />
