...
export const userReducer = (
  ...
  switch (action.type) {
    ...
    case UserActionEnum.UPDATE_USERNAME:
      const update_username_payload = action.payload as string
      const update_username_state = {
        ...state,
        data: {
          ...state.data,
          username: update_username_payload,
        } as ISuperUser,
      }

      setItem(LocalStorageItemEnum.user, update_username_state.data)
      return update_username_state
    ...
    case TalentProfileActionEnum.UPDATE_TAGLINE:
      const update_tagline_payload = action.payload as ITalentProfile["tagline"]

      const update_tagline_state = {
        ...state,
        data: {
          ...state.data,
          tagline: update_tagline_payload,
        },
      }

      setItem(LocalStorageItemEnum.user, update_tagline_state.data)
      return update_tagline_state
