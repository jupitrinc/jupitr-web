...
export const textInputStyles = {
  ...
  lightInput: `block p-2.5 w-full text-xl text-center text-gray-600  hover:bg-gray-50 focus:bg-gray-50 hover:${themeStyles.border.standard} ${themeStyles.disabled}`,
}
