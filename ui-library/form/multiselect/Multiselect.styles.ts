...
export const multiselectStyles = {
  container: `relative text-left space-y-2 z-10`,
  ...
  input: `w-full border-none py-2.5 pl-3 pr-10 text-base z-0 ${themeStyles.backgroundColor.standard[50]} ${themeStyles.textColor.standard[600]} ${themeStyles.border.standard} ${themeStyles.disabled}`,
