...
export const multiselectStyles = {
  ...
  input: `w-full border-none py-2 pl-3 pr-10 text-base ${themeStyles.backgroundColor.standard[50]} ${themeStyles.textColor.standard[600]} ${themeStyles.border.standard} ${themeStyles.disabled}`,
  button: `absolute inset-y-0 right-0 flex items-center pr-2`,
  options: `absolute max-h-40 overflow-y-auto w-full select-none py-2 ${themeStyles.textColor.standard[600]} ${themeStyles.backgroundColor.standard[100]} rounded-lg`,
  option: {
