...
export const buttonStyles = {
  ...
  color: {
    [`${ThemeColorEnum.standard}`]:
      "text-gray-500 ring-gray-900/10 hover:ring-gray-900/20 bg-gray-100 hover:bg-gray-100 active:bg-gray-200 disabled:cursor-not-allowed disabled:text-opacity-50 disabled:hover:text-opacity-50 disabled:hover:text-gray-500 disabled:hover:bg-gray-100 disabled:active:bg-gray-100",
